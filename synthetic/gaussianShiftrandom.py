...
for rho in iters:
    ...
    x33 = np.random.normal(0, sigma, samples) + rho
...
# %%
plt.figure()
plt.title("Sensitivity to uniformative features shift")
...
plt.legend()
plt.tight_layout()
plt.savefig("images/uninformative.png")
plt.show()
# %%
